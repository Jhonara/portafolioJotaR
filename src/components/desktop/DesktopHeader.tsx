...
const DesktopHeader = () => {
  ...
  return <>
    <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.25 }} className="absolute left-5 top-6 z-10 sm:left-10 sm:top-8"><p className="font-mono text-[10px] uppercase tracking-[0.32em] text-cyan-300/70">JOTAR // COMMAND DECK</p><div className="mt-2 flex items-center gap-2 text-xs text-white/45"><span className="h-1.5 w-1.5 animate-pulse rounded-full bg-emerald-400" /> ONLINE · BUILD 2026.08</div></motion.div>
