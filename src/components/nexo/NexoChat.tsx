...
type Props = { open: boolean; messages: NexoMessage[]; input: string; isTyping: boolean; onInput: (value: string) => void; onSubmit: () => void; onClose: () => void; onPrompt: (value: string) => void; prompts: string[]; copy: { title: string; placeholder: string; quick: string; close: string; send: string; typing: string; welcome: string } };
